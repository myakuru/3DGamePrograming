...
void PlayerCameraState_WinnerCamera_3rd::StateStart(PlayerCamera* _owner)
{
...
void PlayerCameraState_WinnerCamera_3rd::StateUpdate(PlayerCamera* _owner)
{
	auto* cam = _owner; if (!cam) return;
...
void PlayerCameraState_WinnerCamera_3rd::StateEnd(PlayerCamera* _owner)
{
}
