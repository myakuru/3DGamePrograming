#include "PlayerCameraState_WinnerCamera_2nd.h"
...
void PlayerCameraState_WinnerCamera_2nd::ApplyFromConfig(const PlayerCameraState& other)
{
	assert(typeid(other) == typeid(PlayerCameraState_WinnerCamera_2nd));
	const auto& p = static_cast<const PlayerCameraState_WinnerCamera_2nd&>(other);
...
void PlayerCameraState_WinnerCamera_2nd::ExposeParametersImGui()
{
...
void PlayerCameraState_WinnerCamera_2nd::LoadParametersJson(const nlohmann::json& js)
{
	if (!js.contains("PlayerCameraState_WinnerCamera_2nd")) return;
	const auto& stateNode = js["PlayerCameraState_WinnerCamera_2nd"];
...
void PlayerCameraState_WinnerCamera_2nd::SaveParametersJson(nlohmann::json& js) const
{
	if (!js.contains("PlayerCameraState_WinnerCamera_2nd")) js["PlayerCameraState_WinnerCamera_2nd"] = nlohmann::json::object();
	auto& stateNode = js["PlayerCameraState_WinnerCamera_2nd"];
