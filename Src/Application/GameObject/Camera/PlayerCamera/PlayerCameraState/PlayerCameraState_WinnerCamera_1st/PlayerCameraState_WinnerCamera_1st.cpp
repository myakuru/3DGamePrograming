#include "PlayerCameraState_WinnerCamera_1st.h"
...
void PlayerCameraState_WinnerCamera_1st::StateStart(PlayerCamera* _owner)
{
...
void PlayerCameraState_WinnerCamera_1st::StateUpdate(PlayerCamera* _owner)
{
	auto* cam = _owner; if (!cam) return;
	...
	{
		auto state = std::make_shared<PlayerCameraState_WinnerCamera_2nd>();
...
void PlayerCameraState_WinnerCamera_1st::StateEnd(PlayerCamera* _owner)
{
}

void PlayerCameraState_WinnerCamera_1st::ApplyFromConfig(const PlayerCameraState& other)
{
	assert(typeid(other) == typeid(PlayerCameraState_WinnerCamera_1st));
	const auto& p = static_cast<const PlayerCameraState_WinnerCamera_1st&>(other);
...
void PlayerCameraState_WinnerCamera_1st::ExposeParametersImGui()
{
...
void PlayerCameraState_WinnerCamera_1st::LoadParametersJson(const nlohmann::json& js)
{
	if (!js.contains("PlayerCameraState_WinnerCamera_1st")) return;
	const auto& stateNode = js["PlayerCameraState_WinnerCamera_1st"];
...
void PlayerCameraState_WinnerCamera_1st::SaveParametersJson(nlohmann::json& js) const
{
	if (!js.contains("PlayerCameraState_WinnerCamera_1st")) js["PlayerCameraState_WinnerCamera_1st"] = nlohmann::json::object();
	auto& stateNode = js["PlayerCameraState_WinnerCamera_1st"];
