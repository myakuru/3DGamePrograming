...
class AetheriusEnemy_Attack_1Effect : public EffekseerEffectBase
{
public:

	static const uint32_t TypeID;

	AetheriusEnemy_Attack_1Effect() { m_typeID = TypeID; }
	~AetheriusEnemy_Attack_1Effect() override = default;
