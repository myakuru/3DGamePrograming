...
class AetheriusEnemy_Attack_2Effect : public EffekseerEffectBase
{
public:

	static const uint32_t TypeID;

	AetheriusEnemy_Attack_2Effect() { m_typeID = TypeID; }
	~AetheriusEnemy_Attack_2Effect() override = default;
