#include "AetheriusEnemy_AttackEffect.h"
#include "Application/Scene/SceneManager.h"
#include "Application/GameObject/Character/EnemyBase/AetheriusEnemy/AetheriusEnemy.h"

const uint32_t AetheriusEnemy_AttackEffect::TypeID = KdGameObject::GenerateTypeID();

void AetheriusEnemy_AttackEffect::Update()
{
	// エフェクサの更新
...
void AetheriusEnemy_AttackEffect::EffectUpdate()
{
...
void AetheriusEnemy_AttackEffect::PlayForEnemy(const std::shared_ptr<AetheriusEnemy>& enemy)
{
	if (!enemy) return;
	// エネミーの前方ベクトル
