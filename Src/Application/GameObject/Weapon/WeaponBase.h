...
public:
	...
	void SetOwnerEnemy(const std::weak_ptr<RedEnemy>& owner) { m_ownerEnemy = owner; }
	const std::weak_ptr<RedEnemy>& GetOwnerEnemy() const { return m_ownerEnemy; }
...
protected:
	...
	std::weak_ptr<RedEnemy> m_ownerEnemy;									// この武器を持っている敵
