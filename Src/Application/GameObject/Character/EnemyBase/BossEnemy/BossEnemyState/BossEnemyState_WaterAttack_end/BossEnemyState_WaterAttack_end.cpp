...
{
	assert(typeid(other) == typeid(BossEnemyState_WaterAttack_end));
	const auto& p = static_cast<const BossEnemyState_WaterAttack_end&>(other);
...
void BossEnemyState_WaterAttack_end::LoadParametersJson(const nlohmann::json& js)
{
	if (!js.contains("BossEnemyState_WaterAttack_end")) return;
	const auto& stateNode = js["BossEnemyState_WaterAttack_end"];
...
void BossEnemyState_WaterAttack_end::SaveParametersJson(nlohmann::json& js) const
{
	if (!js.contains("BossEnemyState_WaterAttack_end")) js["BossEnemyState_WaterAttack_end"] = nlohmann::json::object();
	auto& stateNode = js["BossEnemyState_WaterAttack_end"];
