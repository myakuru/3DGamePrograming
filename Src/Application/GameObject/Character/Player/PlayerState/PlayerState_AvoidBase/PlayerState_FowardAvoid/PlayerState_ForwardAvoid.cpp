#include "PlayerState_ForwardAvoid.h"
#include "Application/main.h"
#include "MyFramework/Manager/JsonManager/JsonManager.h"

void PlayerState_ForwardAvoid::JsonInput(const nlohmann::json& _js)
{
	if (!_js.contains("PlayerState_ForwardAvoid")) return;
	const auto& stateNode = _js["PlayerState_ForwardAvoid"];
...
void PlayerState_ForwardAvoid::JsonSave(nlohmann::json& _js) const
{
	if (!_js.contains("PlayerState_ForwardAvoid")) _js["PlayerState_ForwardAvoid"] = nlohmann::json::object();
	auto& stateNode = _js["PlayerState_ForwardAvoid"];
